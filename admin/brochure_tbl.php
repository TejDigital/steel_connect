...
<div class="content-wrapper" style="overflow-x: hidden;">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Brochure</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="modal fade" id="delete_bro_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="delegate_brochure_code.php" method="POST">
                    <div class="modal-body">
                        <input type="hidden" name="delete_bro_id" class="delete_bro_id">
                        <p>Are you sure , you want to delete this data ?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button type="submit" name="delete_bro" class="btn btn-danger">Yes,Delete.!</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <table id="example1" class="  table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT * FROM brochure_tbl ORDER BY created_at DESC";
                                    ...
                                    ?>
                                            ...
                                            <td><?= $count ++ ?></td>
                                            <td><a href="./brochure/<?= $filds['name'] ?>"><?= $filds['name'] ?></a></td>
                                            <td>
                                                    <?php
                                                        if($filds['status'] == "1"){
                                                            echo"Active";
                                            ...
                                            <td>
                                                ...
                                                <button type='button' value=<?php echo $filds['id']; ?> class='btn btn-danger delete_bro_btn btn-sm my-1'><i class="fa-solid fa-trash"></i></button>
                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="text-dark">Add Brochure</h4>
                            ...
                            <span style="color: red; font-size:0.7rem">* file size limit less then 40mb</span>
                                ...
                                <button type="submit" class="btn btn-info my-2 w-100 " name="add_bro">add</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        $('.delete_bro_btn').click(function(e) {
            e.preventDefault();
            var img_id = $(this).val();
            // console.log(user_id);
            $('.delete_bro_id').val(img_id);
            $('#delete_bro_modal').modal('show');
        });
    });
</script>
